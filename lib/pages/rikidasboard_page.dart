...
class _RikidasboardPageState extends State<RikidasboardPage> {
  ...
  Map<int,Riki2Models>mod ={
    0 : Riki2Models(page:RikiPage(), icon: Icons.home, label: "Home", color: Colors.white),
    1:Riki2Models(page: RikihistoryPage(), icon: Icons.history, label: "History", color: Colors.white),
    2 :Riki2Models(page: RikioutPage(), icon: Icons.output, label: "Out", color: Colors.white),
  };
  @override
